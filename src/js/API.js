...
export const API = {
    ...
    async searchAPIName (name, numberOfPage) {
        try {
            const response = await axios.get(`https://api.themoviedb.org/3/search/movie?api_key=8b9c2b35d1bc0d9e8879c4faa9dd8b75&query=${name}&page=${numberOfPage}`);
    ...
    async searchAPITop () {
        try {
            const response = await axios.get(`https://api.themoviedb.org/3/trending/movie/week?api_key=8b9c2b35d1bc0d9e8879c4faa9dd8b75`);
